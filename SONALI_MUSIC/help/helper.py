...
❖ 𝐏ᴏᴡᴇʀᴇᴅ 𝖡ʏ » [𓆩᪵⟶͇̽[ɪ⃪ϻ̱̱֯༏𐏓⃪꯭𓆩꯭𝗝꯭ᴀ꯭፝֟͠ɴ꯭ɪ꯭꯭ ꯭꯭꯭꯭꯭꯭𔘓꯭𓃭͜ ⃟⛦⃕ ̶꯭𝅥ͦ𝆬 ⃪͢,](https://t.me/Power_of_Jani)**
'''
...
```
 єxᴧϻᴘʟє : @Jani_Music_Robot @Power_of_Jani I love You 😘
```
...
─────────────────────────
❍ ᴄσηᴛᴧᴄᴛ - [𓆩᪵⟶͇̽[ɪ⃪ϻ̱̱֯༏𐏓⃪꯭𓆩꯭𝗝꯭ᴀ꯭፝֟͠ɴ꯭ɪ꯭꯭ ꯭꯭꯭꯭꯭꯭𔘓꯭𓃭͜ ⃟⛦⃕ ̶꯭𝅥ͦ𝆬 ⃪͢,](https://t.me/Power_of_Jani)
─────────────────────────**
'''
    HELP_ABOUT = '''
**─────────────────────────
│ ᴡєʟᴄσϻє ᴛσ ˹[𓆩᪵⟶͇̽[ɪ⃪ϻ̱̱֯༏𐏓⃪꯭𓆩꯭𝗝꯭ᴀ꯭፝֟͠ɴ꯭ɪ꯭꯭ ꯭꯭꯭꯭꯭꯭𔘓꯭𓃭͜ ⃟⛦⃕ ̶꯭𝅥ͦ𝆬 ⃪͢,](https://t.me/Power_of_Jani)˼ ʙσᴛ sᴛᴧᴛυs │
─────────────────────────
       ❖ │ ʀєᴧʟ ᴛɪϻє ʙσᴛ's sᴛᴧᴛυs │❖
─────────────────────────
╭⎋ [ᴊᴀɴɪ 𔘓 ᴍᴜꜱɪᴄ™♪ 𝚁𔘓𝙿 ](https://t.me/Jani_Music_Robot) : ᴧʟɪᴠє 
...
       υsᴧɢє : 24 | ᴧssɪsᴛᴧηᴛs : 01
─────────────────────────
⊚ ʙσᴛ sᴛᴧᴛυs ᴧηᴅ ϻσʀє ʙσᴛs - [ᴄʟɪᴄᴋ ʜєʀє](https://t.me/Power_of_Jani)
─────────────────────────
⊚ ʟᴧsᴛ ᴄʜєᴄᴋєᴅ ση : ᴅᴧᴛє : 10 ᴊᴀɴ 2025 
─────────────────────────
❍ 𝐏ᴏᴡєʀєᴅ 𝖡ʏ » [𓆩᪵⟶͇̽[ɪ⃪ϻ̱̱֯༏𐏓⃪꯭𓆩꯭𝗝꯭ᴀ꯭፝֟͠ɴ꯭ɪ꯭꯭ ꯭꯭꯭꯭꯭꯭𔘓꯭𓃭͜ ⃟⛦⃕ ̶꯭𝅥ͦ𝆬 ⃪͢,](https://t.me/Power_of_Jani)
─────────────────────────**
'''
    HELP_ALLBOT = '''
**─────────────────────────
...
❖ sυᴘᴘσʀᴛ ᴄʜᴧᴛ ➥ [˹Jani Support˼ 💞](https://t.me/+a3O_RK3xMbA1ZGZl)
❖ ʙᴏᴛ σᴡηєʀ ➥ [Jani 💕](https://t.me/Power_of_Jani)
❖ ʀєᴘσ ʟɪηᴋ ➥ [ᴄʟɪᴄᴋ-ʜєʀє](https://t.me/Power_of_Jani)
─────────────────────────
